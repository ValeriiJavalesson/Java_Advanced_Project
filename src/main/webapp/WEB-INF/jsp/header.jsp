		...
		<nav
			...
			<div class="container-fluid">
				<a class="navbar-brand text-light m-0 me-3 ms-2"
					...
					height='50px'></a> <a href="home" class="btn"><span class="text-light fw-semibold h4 m-1 ms-0" >UNIVERSITY</span></a>
		...
		<div class="offcanvas offcanvas-start" tabindex="-1"
			...
			<div class="offcanvas-body">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a
							class="nav-link text-dark fw-semibold" type="button"
							data-bs-dismiss="offcanvasExample" href="faculties">Faculties</a></li>					
					<security:authorize access="hasRole('ROLE_ADMIN')">
						...
						<li class="nav-item "><a
							...
							type="button" href="reports">All Reports</a></li>				
				</ul>
			</div>
		</div>
	</header>
